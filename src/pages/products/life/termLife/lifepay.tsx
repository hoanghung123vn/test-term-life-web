...
const LifePay = () => {
    ...
    const [lifePolicy, setLifePolicy] = useState(location.state.lifePolicy);
    const collection = useState(location.state.lifePolicy.collection);
    ...
    const clickBack = () => {
        navigate('/lifePolicyInfo', { state: { lifePolicy: lifePolicy } });
    }
    const clickDialogOK = () => {
        //reset policy in redux store so we can start a new one
        // resetLifePolicy();
        setDialogVisible(false);
        navigate('/lifeHomePage');
    }
        ...
        <>
            <Space>
                ...
                <div className='top_box_content'>
                    ...
                    <span className='lifeTitle_sub'>Term Life</span>
                </div>
            </Space>
